...
const String dataUrl = "10.0.20.25/hardware"; //Just the IP address ex. 172.18.80.11 //older one:  sms.concordiashanghai.org/bdst
const String firmwareVers = "***";
...
void reConnect() {
  ...
  if (activeConnection) readCurves();
}
